...
set tracefile [open meshCBQ.tr w]
$ns trace-all $tracefile

#Open the NAM trace file
set namfile [open meshCBQ.nam w]
...
$ns duplex-link $n0 $n4 100.0Mb 10ms CBQ
$ns queue-limit $n0 $n4 50
$ns duplex-link $n4 $n3 100.0Mb 10ms CBQ
$ns queue-limit $n4 $n3 50
$ns duplex-link $n3 $n2 100.0Mb 10ms CBQ
$ns queue-limit $n3 $n2 50
$ns duplex-link $n2 $n1 100.0Mb 10ms CBQ
$ns queue-limit $n2 $n1 50
$ns duplex-link $n1 $n0 100.0Mb 10ms CBQ
$ns queue-limit $n1 $n0 50
$ns duplex-link $n0 $n3 100.0Mb 10ms CBQ
$ns queue-limit $n0 $n3 50
$ns duplex-link $n0 $n2 100.0Mb 10ms CBQ
$ns queue-limit $n0 $n2 50
$ns duplex-link $n1 $n3 100.0Mb 10ms CBQ
$ns queue-limit $n1 $n3 50
$ns duplex-link $n4 $n2 100.0Mb 10ms CBQ
$ns queue-limit $n4 $n2 50
$ns duplex-link $n1 $n4 100.0Mb 10ms CBQ
